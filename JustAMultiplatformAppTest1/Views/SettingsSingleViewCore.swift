...
//  @Environment(\.dismiss) var dismiss
    ...
    private func downloadAppReleaseUpdate()
    {
        ...
        let urlToOpen:URL = URL(string:"itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/DFW-PMA/JustAMultiplatformAppTest1/refs/heads/main/JustAMultiplatformAppTest1.plist")!
    ...
    private func downloadAppPreReleaseUpdate()
    {
        ...
        let urlToOpen:URL = URL(string:"itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/DFW-PMA/JustAMultiplatformAppTest1/refs/heads/main/JustAMultiplatformAppTest1_Pre.plist")!
